...
class PasswordRecovery(BasePage):
    ...
    @allure.step('Ожидание, когда поле Пароль станет активным')
    ...
    @allure.step('Ожидание, когда Восстановить Пароль станет активным')
    ...
    @allure.step('Ожидание и нажатие кнопки скрыть/показать пароль')
