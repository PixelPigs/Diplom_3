...
class OrderFeedPage(BasePage):
    ...
    @allure.step('Всплывающее окно заказа')
    ...
    @allure.step("Совпадение заказа в истории и ленте")
